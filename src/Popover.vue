  ...
  export default class Popover extends Vue {
    ...
    onClickDocument(e) {
      if (this.$refs.popover &&
        (this.$refs.popover === e.target || (this.$refs.popover as HTMLDivElement).contains(e.target))
      ) { return; }
      if (this.$refs.contentWrapper &&
        (this.$refs.contentWrapper === e.target || (this.$refs.contentWrapper as HTMLDivElement).contains(e.target))
      ) { return; }
      this.close();
    }
